...
//course: csc1720 sec 2
//descroption:stacks and link list reversed
#ifndef H_StackType
#define H_StackType
...
public:
  ...
  void reverseLinkedStack(linkedStackType<Type>& otherStack);
...
//creates a copy of the list in revers
//clears the list to create new reverse list
template<class Type>
 void linkedStackType<Type>::reverseLinkedStack(linkedStackType<Type> &otherStack)
 {
linkedStackType<Type> temp;
